...
class MainApp(MDApp):
    ...
    def Law(self):
        ...
        if btn_1.text != "" and btn_2.text != "" and btn_3.text != "" and btn_4.text != "" and btn_5.text != "" and btn_6.text != "" and btn_7.text != "" and btn_8.text != "" and btn_9.text != "":
            result.text = "Result Is : Tie"
            self.state = True
            turn.text = "Turn : Player 'X'"
            MainApp.Delete_value(self)
            result_score.text = f"Score Player 'X' Is : {self.Score_player_X}" \
